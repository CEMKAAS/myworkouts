...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(MyConstanta.TABLE_STRUCTURE_NAME);
        db.execSQL(MyConstanta.TABLE_STRUCTURE_PARAMETER);
        db.execSQL(MyConstanta.TABLE_STRUCTURE_WORKOUT);
        db.execSQL(MyConstanta.TABLE_STRUCTURE_EXERCISE);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS MyConstanta.DROP_TABLE_PERSON");
        db.execSQL("DROP TABLE IF EXISTS MyConstanta.DROP_TABLE_PARAMETER");
        db.execSQL("DROP TABLE IF EXISTS MyConstanta.DROP_TABLE_WORKOUT");
        db.execSQL("DROP TABLE IF EXISTS MyConstanta.DROP_TABLE_EXERCISE");
        onCreate(db);
    }
